...
{
    public class MoveWindow : Window, IFunctionalWindow
    {
        ...
        public MoveWindow(int x, int y, int w, int h, ConsoleColor fore_Col, ConsoleColor back_Col, MainPanels panels) : base(x, y, w, h, fore_Col, back_Col)
        {
            this.Panels = panels;
            ...
            Button btnOk = new Button(false, this.X+(this.Width / 2)-7, this.Y + 1 + textbox1.Height + 1 + textbox2.Height + 1, 6, 1, "[ Ok ]", ConsoleColor.Black, ConsoleColor.DarkBlue, ConsoleColor.DarkGreen);
            Button btnCancel = new Button(false, this.X+(this.Width / 2), this.Y + 1 + textbox1.Height + 1 + textbox2.Height + 1, 10, 1, "[ Cancel ]", ConsoleColor.Black, ConsoleColor.DarkBlue, ConsoleColor.DarkGreen);
